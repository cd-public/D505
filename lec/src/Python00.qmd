...
2. Quarto Render `hello.qmd` either by pressing [>] or by using ctrl+shift+k.
3. After a moment, a document will be rendered.
4. Prefix the .md document with a .qmd header:
