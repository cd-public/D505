...
- ... which is about 22% of 1%

## Dependent
- Can $\log$ both of the:
  - Dependent/response variable, and 
  - Independent/predictor variable(s).
- The coefficient is the ratio between percent changes.
...
- Example: the coefficient is 0.198. 
  ...
  - That is, 20% of 1% or .2 times 1%.
- A $30 bottle of wine scoring 90 would be worth $30.06 as a 91.
  - We should probably transform scores from [80-100] to [0-20]
...
fit <- knn(
  ...
  k=5, 
  cl = train$province, 
  prob = T) # 'votes' for the winning class are returned as attribute prob
```

## Confusion matrix

- Remember to scroll, a lot there!
